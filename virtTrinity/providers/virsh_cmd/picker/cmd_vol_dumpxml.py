...
from virtTrinity.providers.virsh_cmd.picker.cmds import CmdVolDumpxmlChecker
from virtTrinity.providers.virsh_cmd import data


class CmdVolDumpxmlPoolVolumePairPicker(picker.Picker):
    depends_on = CmdVolDumpxmlChecker
...
class CmdVolDumpxmlVolPicker(picker.Picker):
    depends_on = CmdVolDumpxmlChecker
...
class CmdVolDumpxmlPoolPicker(picker.Picker):
    depends_on = CmdVolDumpxmlChecker
    data_type = common_data.String()
    types = {
        "positive": {
